...
public class ImmutableTriplet<P, S, V> implements Triplet<P, S, V> {

    private final Map<P, ImmutableTripletObject<P, S, V>> primaryMap = new HashMap<>();
    private final Map<S, ImmutableTripletObject<P, S, V>> secondaryMap = new HashMap<>();
